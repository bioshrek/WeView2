...
- (NSString *)layoutDescription
{
    ...
    [result appendString:[self formatLayoutDescriptionItem:@"skipLayout" value:@(self.skipLayout)]];
...
- (BOOL)skipLayout
{
    return [self.viewInfo skipLayout];
}

- (UIView *)setSkipLayout:(BOOL)value
{
    [self.viewInfo setSkipLayout:value];
    [self.superview setNeedsLayout];
    return self;
}
