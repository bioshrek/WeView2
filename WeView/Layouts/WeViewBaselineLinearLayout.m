//
//  WeViewBaselineLinearLayout.m
//  RapidCalculation
//
//  Created by jiangxiaolong on 2017/2/6.
//  Copyright © 2017年 knowin. All rights reserved.
//

#import "WeViewBaselineLinearLayout.h"
...
@interface WeViewBaselineLinearLayout ()
...
@implementation WeViewBaselineLinearLayout
               ...
               subview:(UIView *)subview
{
    switch ([self subviewCellVAlign:subview])
    {
        ...
        case V_ALIGN_CENTER:
        {
            ...
            CGFloat baseline = [subview getBaseLine];
            index = index + (subview.frame.size.height/2 - baseline);
            return index;
        }
        case V_ALIGN_BOTTOM:
            return index + extraSpace;
...
+(WeViewBaselineLinearLayout *)horizontalBaselineLayout
{
    WeViewBaselineLinearLayout *layout = [[WeViewBaselineLinearLayout alloc] init];
